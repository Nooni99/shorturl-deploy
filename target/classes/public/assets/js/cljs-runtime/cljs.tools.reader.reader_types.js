...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41589 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41589(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41594 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41594(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41595 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41595(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41597 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41597(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41602 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41602(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41606 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41606(reader);
}
});
...
var G__41676 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41677 = s.append(c);
c = G__41676;
s = G__41677;
continue;
}
