...
var i_33626 = (0);
while(true){
if((i_33626 < arr.length)){
(arr[i_33626] = null);

var G__33627 = (i_33626 + (1));
i_33626 = G__33627;
continue;
} else {
}
...
var i_33634 = (self__.level + (1));
while(true){
if((i_33634 <= (new_level + (1)))){
(update[i_33634] = self__.header);

var G__33635 = (i_33634 + (1));
i_33634 = G__33635;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33636 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33636[i]));
} else {
x__$2.forward.push((((i < links_33636.length))?(links_33636[i]):null));
}

if((i < links_33636.length)){
(links_33636[i] = x__$2);
} else {
links_33636.push(x__$2);
}
...
var i_33638 = (0);
while(true){
if((i_33638 <= self__.level)){
var links_33639 = (update[i_33638]).forward;
if((x__$1 === (((i_33638 < links_33639.length))?(links_33639[i_33638]):null))){
(links_33639[i_33638] = (x__$1.forward[i_33638]));

var G__33640 = (i_33638 + (1));
i_33638 = G__33640;
continue;
} else {
var G__33641 = (i_33638 + (1));
i_33638 = G__33641;
continue;
}
} else {
...
var G__33643 = nx;
var G__33644 = (level__$1 - (1));
x = G__33643;
level__$1 = G__33644;
continue;
} else {
var G__33645 = x;
var G__33646 = (level__$1 - (1));
x = G__33645;
level__$1 = G__33646;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33648 = nx;
var G__33649 = (level__$1 - (1));
x = G__33648;
level__$1 = G__33649;
continue;
} else {
var G__33650 = x;
var G__33651 = (level__$1 - (1));
x = G__33650;
level__$1 = G__33651;
continue;
}
