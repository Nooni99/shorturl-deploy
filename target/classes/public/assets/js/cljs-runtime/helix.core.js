...
var len__5769__auto___41849 = arguments.length;
var i__5770__auto___41850 = (0);
while(true){
if((i__5770__auto___41850 < len__5769__auto___41849)){
args__5775__auto__.push((arguments[i__5770__auto___41850]));

var G__41851 = (i__5770__auto___41850 + (1));
i__5770__auto___41850 = G__41851;
continue;
} else {
}
break;
...
var props_STAR_ = (function (){var G__41638 = cljs.core.PersistentArrayMap.EMPTY;
var G__41638__$1 = ((has_props_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__41638,_QMARK_p):G__41638);
if((!((children == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41638__$1,new cljs.core.Keyword(null,"children","children",-940561982),children);
} else {
return G__41638__$1;
}
})();
...
/** @this {Function} */
(helix.core.$.cljs$lang$applyTo = (function (seq41624){
var G__41625 = cljs.core.first(seq41624);
var seq41624__$1 = cljs.core.next(seq41624);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41625,seq41624__$1);
}));
...
var helix$core$IExtractType$_type$dyn_41852 = (function (factory){
...
return helix$core$IExtractType$_type$dyn_41852(factory);
}
});
...
while (G__41854__i < G__41854__a.length) {G__41854__a[G__41854__i] = arguments[G__41854__i + 0]; ++G__41854__i;}
  args = new cljs.core.IndexedSeq(G__41854__a,0,null);
} 
return helix$core$factory_$_factory__delegate.call(this,args);};
helix$core$factory_$_factory.cljs$lang$maxFixedArity = 0;
helix$core$factory_$_factory.cljs$lang$applyTo = (function (arglist__41855){
...
;
(x41659.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x41659.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
helix$core$cljs_factory_$_factory.cljs$lang$applyTo = (function (arglist__41857){
var args = cljs.core.seq(arglist__41857);
...
;
(x41822.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x41822.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(prev_props),cljs.core.count(cur_props))) && (cljs.core.every_QMARK_((function (p1__41825_SHARP_){
return (cljs.core.get.cljs$core$IFn$_invoke$arity$2(prev_props,p1__41825_SHARP_) === cljs.core.get.cljs$core$IFn$_invoke$arity$2(cur_props,p1__41825_SHARP_));
...
var G__41830 = helix.core.extract_cljs_props(o);
var G__41831 = helix.core.extract_cljs_props(o_SINGLEQUOTE_);
return (compare.cljs$core$IFn$_invoke$arity$2 ? compare.cljs$core$IFn$_invoke$arity$2(G__41830,G__41831) : compare.call(null,G__41830,G__41831));
}));
}));
...
var G__41834 = this$;
var G__41835 = helix.core.extract_cljs_props(this$.props);
var G__41836 = this$.state;
return (render.cljs$core$IFn$_invoke$arity$3 ? render.cljs$core$IFn$_invoke$arity$3(G__41834,G__41835,G__41836) : render.call(null,G__41834,G__41835,G__41836));
});
...
(ref.current = (function (){var x41839 = ({"current": initial_value});
(x41839.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x41839.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x41839.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x41839.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,x){
var this$__$1 = this;
return (this$__$1.current = x);
}));

(x41839.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x41839.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__41840 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__41840) : f.call(null,G__41840));
})());
}));

(x41839.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__41841 = this$__$1.current;
var G__41842 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__41841,G__41842) : f.call(null,G__41841,G__41842));
})());
}));

(x41839.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__41843 = this$__$1.current;
var G__41844 = a;
var G__41845 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__41843,G__41844,G__41845) : f.call(null,G__41843,G__41844,G__41845));
})());
}));

(x41839.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
