...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33806 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33806(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33808 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33808(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33812 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33812(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33822 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33822(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33826 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33826(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33830 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33830(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33800,callback){
var map__33801 = p__33800;
var map__33801__$1 = cljs.core.__destructure_map(map__33801);
var input = map__33801__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33801__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33801__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
