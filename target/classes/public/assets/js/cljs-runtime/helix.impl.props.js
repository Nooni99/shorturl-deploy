...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__41401_SHARP_,p2__41400_SHARP_){
return p2__41400_SHARP_.toUpperCase();
}));
...
var G__41402 = o;
helix.impl.props.goog$module$goog$object.set(G__41402,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__41412 = cljs.core.rest(m);
var G__41413 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41405_SHARP_){
if(cljs.core.map_QMARK_(p1__41405_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__41405_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__41416 = cljs.core.rest(m);
var G__41417 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__41420 = cljs.core.rest(m);
var G__41421 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
