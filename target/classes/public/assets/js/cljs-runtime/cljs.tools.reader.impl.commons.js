...
var G__42019 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__42019;
continue;
} else {
return ch;
...
var vec__42005 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42005,(0),null);
return (match === s);
});
...
var len__5769__auto___42020 = arguments.length;
var i__5770__auto___42021 = (0);
while(true){
if((i__5770__auto___42021 < len__5769__auto___42020)){
args__5775__auto__.push((arguments[i__5770__auto___42021]));

var G__42022 = (i__5770__auto___42021 + (1));
i__5770__auto___42021 = G__42022;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq42011){
...
return (function() { 
var G__42023__delegate = function (rdr,_){
...
var G__42023 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__42024__i = 0, G__42024__a = new Array(arguments.length -  1);
while (G__42024__i < G__42024__a.length) {G__42024__a[G__42024__i] = arguments[G__42024__i + 1]; ++G__42024__i;}
  _ = new cljs.core.IndexedSeq(G__42024__a,0,null);
} 
return G__42023__delegate.call(this,rdr,_);};
G__42023.cljs$lang$maxFixedArity = 1;
G__42023.cljs$lang$applyTo = (function (arglist__42025){
var rdr = cljs.core.first(arglist__42025);
var _ = cljs.core.rest(arglist__42025);
return G__42023__delegate(rdr,_);
});
