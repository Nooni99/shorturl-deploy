...
var G__40487 = cljs.core.next(xs);
var G__40488 = cljs.core.next(ys);
xs = G__40487;
ys = G__40488;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__40429 = val;
var G__40430 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__40429,G__40430) : f.call(null,G__40429,G__40430));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__40432 = val__$1;
var G__40433 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__40432,G__40433) : f.call(null,G__40432,G__40433));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__40435 = val__$1;
var G__40436 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__40435,G__40436) : f.call(null,G__40435,G__40436));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__40497 = cljs.core.next(es);
var G__40498 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__40497;
tcoll__$1 = G__40498;
continue;
} else {
...
var G__40501 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__40502 = cljs.core.next(es);
ret = G__40501;
es = G__40502;
continue;
} else {
